    ...
    export default function Dropdown({
        ...
        const getDropdownStyles = () => {
            const sharedStyles = {
                ...
                menuBase:
                    'absolute left-0 top-12 bg-white border rounded-lg shadow-md z-10 max-h-40 overflow-y-auto',
            ...
            switch (type) {
                case '모달':
                    return {
                        ...
                        menu: 'absolute left-0 top-13 bg-white md:w-118 w-85.75  border rounded-xl shadow-sm z-10 max-h-44 overflow-y-auto',
